<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="raw_view_edit.aspx.cs" Inherits="production_management.raw_view_edit" %>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h5 class="title"> Raw Material Edit </h5>
                    </div>
                    <div class="card-body">
                        <form runat="server">
                            <div class="row">
