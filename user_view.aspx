<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="user_view.aspx.cs" Inherits="production_management.user_view" %>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h5 class="title"> User 
                            <a href="user_master_add.aspx" style="margin-left:450PX">  ADD NEW </a>
                        </h5>
                    </div>
                    <div class="card-body">
                        <form runat="server">
                                ...
                                <div class="col-md-12">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <td><%#Eval("password") %></td>
                                            <td>
                                                <a href="user_master_edit.aspx?user_id=<%#Eval("user_id") %>"> Edit</a>
                                                |
                                                 <a href="user_view.aspx?user_id=<%#Eval("user_id") %>"> Delete </a></td>
                                            </tr>
