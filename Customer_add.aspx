<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Customer_add.aspx.cs" Inherits="production_management.Customer_add" %>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h5 class="title"> Customer Add </h5>
                    </div>
                    <div class="card-body">
                        <form runat="server">
                            <div class="row">
