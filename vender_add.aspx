<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="vender_add.aspx.cs" Inherits="production_management.vender_add" %>
<asp:Content ID="Content1" runat="server" contentplaceholderid="cplace">
    <div class="content">
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h5 class="title"> Vendor Add </h5>
                    </div>
                    <div class="card-body">
                        <form runat="server">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtName" runat="server" class="form-control" placeholder="Name of Vendor" />
                                    </div>
                                </div>
