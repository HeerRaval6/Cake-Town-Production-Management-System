...
{
    public partial class raw_view : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string qdel = "delete from raw_material where raw_id=" + Request.QueryString["raw_id"];
            ...
            if (!IsPostBack)
            {
                ...
                string q = "select * from raw_material";
